  ...
  return (
    <div className="flex justify-between items-end mb-8">
      <div>
        ...
        <p className="text-secondary mt-2">Live behavioral model and skill topography.</p>
      </div>
      <div className="flex items-center gap-2 bg-accent-green-bg border border-accent-green/30 rounded-full px-3 py-1.5">
        ...
        <span className="font-mono text-[10px] tracking-widest text-accent-green">SYNCED JUST NOW</span>
      </div>
    </div>
  );
}
