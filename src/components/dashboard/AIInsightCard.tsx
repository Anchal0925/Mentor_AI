...
export function AIInsightCard() {
  return (
    <Card className="border-l-[3px] border-l-accent-green sticky top-[80px]">
      ...
      <p className="text-sm text-primary leading-relaxed mb-6 font-body">
      ...
      <Link to="/session/dp-101" className="inline-flex items-center gap-2 text-sm font-semibold text-accent-green hover:brightness-110 transition-colors">
